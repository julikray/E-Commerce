...
import { getCategory } from "../../store/Reducers/categoryReducer.js";
import { addProduct , messageClear } from "../../store/Reducers/productReducer.js";
...
function AddProduct() {
  ...
  const add = (e) => {
    ...
    formData.append("shopName", "EShop");
