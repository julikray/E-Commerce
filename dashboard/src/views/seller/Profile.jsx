                ...
                <div className='flex justify-center items-center py-3' >
                    {
                        image ? <label htmlFor="img" className='h-[150px] w-[200px] relative p-3 cursor-pointer overflow-hidden ' >
                           <img className= "bg-red-500 w-full h-full" src={logo} alt="Logo" />

                           {
                                !loader && <div className='bg-[#6f6f70] absolute left-0 top-0 w-full h-full opacity-70 flex justify-center items-center z-20 ' >
                                    <span>
                                        <FadeLoader />
                        ...
                        </label> : <label className="flex justify-center items-center flex-col h-[150px] cursor-pointer border border-dashed hover:border-red-500 w-[200px] border-[#6f6f70] mb-3 relative " htmlFor="img" >
                             <span><FaImage /></span>
                ...
                <div className='px-0 md:px-5 py-2' >
                    <div className='flex justify-between text-sm flex-col gap-2 p-4 border border-[#cfcfcf]  rounded-md relative ' >
                        ...
                        <div className='flex gap-2 text-[#6f6f70]  ' >
                            ...
                            <p>
                                {
                                    status === 'active' ? <span className='bg-green-500 text-white text-xs cursor-pointer font-normal ml-2 px-2 py-0.5 rounded ' >
                                        Pending
                                    </span> : <span className='bg-blue-500 text-white text-xs cursor-pointer font-normal ml-2 px-2 py-0.5 rounded ' >
                                        Click Active
                                    </span> 
                                }
                            </p>
...
<div className="flex flex-col w-full gap-1 mb-2">
              ...
              <button className="bg-red-500 w-full hover:shadow-red-500/40 hover:shadow-md text-white rounded-md px-7 py-2 ">
                Save Changes
                        ...
                        </form> : <div className='flex justify-between text-sm flex-col gap-2 p-4 border border-[#cfcfcf]  rounded-md relative ' >
                        <span className='p-[6px] bg-yellow-500 rounded hover:shadow-lg hover:shadow-yellow-500/50 absolute right-2 top-2 cursor-pointer ' >
                           <FaEdit/>
            ...
            <div className='w-full pl-0 md:pl-7 mt-6 md:mt-0  ' >
                <div className=' bg-[#fefeff] rounded-md border border-[#d2d3d2] text-[#6f6f70] p-4' >
                    <h1 className='text-[#6f6f70] text-lg mb-3 font-semibold ' >Change Password</h1>
