...
// import { FaFacebookF, FaHeart, FaList, FaSearch, FaUser } from "react-icons/fa";
// import { FaTwitter } from "react-icons/fa";
// import { FaLinkedinIn, FaMicrophone } from "react-icons/fa6";
...
//           alert(
//             "Voice search requires internet and a secure (HTTPS) connection."
//           );
//         } else if (event.error === "not-allowed") {
//           alert("Please allow microphone access to use voice search.");
//         } else {
//           alert("An error occurred during voice search: " + event.error);
//         }
...
//     // if (!isSecure) {
//     //   alert("Voice search works only on HTTPS or localhost.");
//     //   return;
//     // }
...
//                   <button
//                     // className="flex items-center justify-center px-3 text-[#836bca] hover:text-[#6f6f70] transition-colors"

//                     className={`flex items-center justify-center px-3 transition-colors ${
//                       isListening ? "text-red-500" : "text-[#836bca]"
//                     }`}
//                     title="Voice Search"
...
//                   <button
//                     onClick={search}
//                     className="flex items-center justify-center gap-2 bg-[#836bca] px-6 h-full font-semibold uppercase text-white"
//                   >
//                     <FaSearch />
...
//                     className="absolute right-[120px] flex items-center justify-center p-2"
//                     title="Voice Search"
//                   >
//                     <FaMicrophone/>
//                   </button> */}
