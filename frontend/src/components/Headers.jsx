        ...
        <div className="w-[85%] lg:w-[90%] mx-auto " >
          <div className="flex w-full flex-wrap md-lg:gap-8  " >
            ...
            <div className="bg-white relative" >
              <div onClick={() => setCategory(!category) }  className="h-[50px] bg-[#836bca] text-white flex justify-center md-lg:justify-between md-lg:px-6 items-center gap-3 font-bold text-md cursor-pointer " >
              ...
              <div className={`${category ? 'h-0' : `h-[400px]` } overflow-hidden transition-all md-lg:relative duration-500 absolute z-[99999] bg-[#ae88f1]  w-full border-0 `} >

                <ul className="py-2 font-medium " >
                  {
                    categoryList.map((c,i)=>{
                      return(
                        <li key={i} className="flex justify-center items-center gap-2 px-[24px] py-[6px] " >
            ...
            <div className="flex flex-wrap w-full justify-between items-center md-lg:gap-6" >
              ...
              <div className="flex border h-[50px] items-center relative gap-6 " >
                <div className="relative after:absolute after:h-[25px] after:w-[1px] after:bg-[#afafaf] after:-right-[15px] md:hidden " >
                  <select className="w-[150px] text-slate-600 font-semibold bg-transparent px-2 h-full outline-0 border-none " name="" id="">
                    <option value="">Select Category </option>
                    {
                      categoryList.map((c,i)=> <option value={c} > {c} </option> )
                    }
                  </select>
                ...
                <button className="bg-[#836bca] right-0 absolute px-8 h-full font-semibold uppercase text-white " >Search</button>
