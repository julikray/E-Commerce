      ...
      <div className="flex flex-col gap-8 pb-10 pt-4 " >
        {
          ...
          <span className="text-slate-600 text-md " >Juli kumari</span>
          <p className="text-slate-600 text-sm " >Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi magni at iure dolore saepe, doloremque eligendi sed explicabo voluptate facilis labore non distinctio enim accusantium voluptatibus fugit, assumenda quaerat dicta?</p>
